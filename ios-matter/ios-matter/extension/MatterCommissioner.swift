...
@objc public final class MatterCommissioner : NSObject {

    /// Provides access to the Matter controller used for commissioning.
    private let provider = LocalControllerProvider(logTag: "MatterCommissioner")
    ...
    @objc public func commission(payload: String, nodeID: NSNumber) async throws {
    ...
    @objc public func releaseCommissioner() {
        provider.release()
    }
}
